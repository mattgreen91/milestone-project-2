...
$("#change-objects").on("click", function (event) {
  $.getJSON("./assets/json/word-scrambler.json", function (gameData) {
    ...
    $.fn.scramble();
    console.log(
      "after clicking category button, the list of words is " + category
    );
  });
});
...
$.fn.scramble = function () {
  ...
  $("#word-scrambler-game").on("submit", function (event) {
    ...
    if (answer) {
      console.log(
        "after checking answer is answer, the list of words is " + category
      );
      ...
      if (answer == word) {
        console.log(
          "when the answer is right, the list of words is " + category
        );
        // displays the result
        alert(
          'Well done! "' +
        ...
        console.log(
          "when the answer is wrong, the list of words is " + category
        );
        alert(
          'Sorry "' +
            answer.toLowerCase() +
